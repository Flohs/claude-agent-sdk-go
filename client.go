...
// key to clear that override (e.g. map[string]any{"agent": nil} resets to
// the default agent). Requires a connected client.
// Port of TypeScript SDK v0.2.132 / v0.3.161.
