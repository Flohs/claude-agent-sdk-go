...
// Servers already connected are preserved when included in the new map; servers
// omitted from the map are disconnected. New servers are connected on demand.
// Builtin servers (e.g. "claude-in-chrome") can be added even if the CLI was
// launched without them. Port of TypeScript SDK v0.3.163 / v0.3.166.
