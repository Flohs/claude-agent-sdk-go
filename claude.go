...
// normalizePromptContent wraps a string starting with "/ " (slash followed by
// whitespace) in array content so the CLI does not silently drop it as a
// malformed slash command. The original text is preserved verbatim.
