...
- `Model` type alias for `string` and exported model-name constants: `ModelSonnet`, `ModelOpus`, `ModelHaiku`, `ModelFable` (short alias), and `ModelFable5` (`"claude-fable-5"` full ID). Eliminates magic strings in consumer code. Port of TypeScript SDK v0.3.170. ([#369](https://github.com/Flohs/claude-agent-sdk-go/issues/369))
