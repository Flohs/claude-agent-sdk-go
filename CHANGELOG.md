...
- `Model` type alias (`= string`) for use with `Options.Model`. Fully interchangeable with `string` — no migration needed. The named constants (`ModelFable5`, `ModelOpus48`, etc.) were already added in [#348](https://github.com/Flohs/claude-agent-sdk-go/issues/348); this adds the documented type alias. Port of TypeScript SDK v0.3.170. ([#369](https://github.com/Flohs/claude-agent-sdk-go/issues/369))
