...
- `ModelFable5 = "claude-fable-5"`, `ModelFable = "fable"`, `ModelOpus48 = "claude-opus-4-8"`, `ModelOpus = "opus"`, `ModelSonnet46 = "claude-sonnet-4-6"`, `ModelSonnet = "sonnet"`, `ModelHaiku45 = "claude-haiku-4-5-20251001"`, and `ModelHaiku = "haiku"` model string constants in a new `models.go` file. Short aliases resolve server-side to the latest model generation; versioned constants pin to a specific release for reproducible deployments. Port of TypeScript SDK v0.3.170. ([#348](https://github.com/Flohs/claude-agent-sdk-go/issues/348))
